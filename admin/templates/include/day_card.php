<div class="card mb-3">
        ...
        <div class="row">
            <div class="col-auto">
                <form action="days.php?event_id=<?= $this->e($event_id) ?>" method="POST" class="update"
                    autocomplete="off">
                    <?= $this->insert("main::csrf_token", ["form_name" => "days_update_form"]) ?>
            ...
            <div class="col-auto ms-auto">
                <form class="delete" action="days.php?event_id=<?= $this->e($event_id) ?>" method="POST"
                    ...
                    <?= $this->insert("main::csrf_token", ["form_name" => "days_delete_form"]) ?>
    ...
    <div class="card-body">
        ...
        <form action="timewindows.php?day_id=<?= $this->e($id) ?>" id="timewindow_add_<?= $this->e($id) ?>"
            ...
            <?= $this->insert("main::csrf_token", ["form_name" => "timewindows_create_form"]) ?>
